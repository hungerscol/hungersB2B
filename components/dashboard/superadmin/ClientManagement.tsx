                                            ...
                                            <ul className="text-sm space-y-1">
                                                {items.map((item, index) => (
                                                    <li key={index} className="flex justify-between text-green-800">
                                                        ...
                                                        <span className="font-medium">{formatCurrency((item.menuItem?.price || 0) * item.quantity, item.menuItem?.currency || 'COP')}</span>
                                                    </li>
                                                ))}
                                            </ul>
                                        </div>
                    ...
                    <tbody>
                        {clients.map(client => (
                            <tr key={client.id} className="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td className="px-5 py-4 text-sm text-green-700">{(client as any).city || 'N/A'}</td>
